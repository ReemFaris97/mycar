...
@section('title','إنشاء قسم فرعي')
@section('content')

    <div class="row">
        <div class="col-sm-12">

            <form data-parsley-validate novalidate method="POST" action="{{route('subcategories.store')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <!-- Page-Title -->
                        <h4 class="page-title">إنشاء قسم فرعي</h4>
                    </div>
                </div>
