...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">تعديل مقترح</h4>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    ...
                    <form method="post" action="{{route('proposals.update',$proposal->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{method_field('PUT')}}
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" required value="{{$proposal->ar_name}}"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{--<label class="col-md-2 control-label">الإسم*</label>--}}
                                <div class="col-md-10">
                                    <input type="text" required value="{{$proposal->en_name}}"
                                           data-parsley-required-message="هذا الحقل مطلوب"
                                           data-parsley-trigger="keyup"
                                           data-parsley-maxlength="60"
                                           data-parsley-maxlength-message="أقصى عدد حروف هو 60 حرف"
                            ...
                            <div class="form-group">
                                <div class="col-md-10">
                                    <input name="image" type="file" class="dropify" data-max-file-size="6M"
                                           ...
                                           data-default-file="{{getimg($proposal->image)}}"
                                    />
