...
@section('title','إنشاء قسم رئيسي')
@section('content')

    <div class="row">
        <div class="col-sm-12">

            <form data-parsley-validate novalidate method="POST" action="{{route('categories.store')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <!-- Page-Title -->
                        <h4 class="page-title">إنشاء قسم رئيسي</h4>
                    </div>
                </div>
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    {{--<option value="" selected disabled>إختار الدولة</option>--}}
