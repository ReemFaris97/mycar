...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form data-parsley-validate novalidate method="POST" action="{{route('models.update',$model->id)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{method_field('PUT')}}
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <!-- Page-Title -->
                        <h4 class="page-title">تعديل موديل</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="card-box">
                            <h4 class="header-title m-t-0 m-b-30">تعديل الموديل</h4>
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <select name="company_id" required class="form-control"
                                            ...
                                            @foreach ($companies as $company)
                                                ...
                                                @if($company->id == $model->company->id)
                                                    selected
                                                    @endif
                                                >{{$company->ar_name}}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="ar_name" required value="{{$model->ar_name}}"
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="en_name" required value="{{$model->en_name}}"
