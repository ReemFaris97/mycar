...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('supplier/assets/images/logo-sm.png')}}">
    ...
    <title>@yield('title')</title>
        ...
        @include('suppliers.layout.styles')
...
@include('suppliers.layout.header')


    <!-- ========== Left Sidebar Start ========== -->
    @include('suppliers.layout.menu')
    <!-- Left Sidebar End -->
    ...
    <div class="content-page">
        ...
        @include('suppliers.layout.footer')
        <audio id="myAudio">
    ...
    <!-- Notifications -->
    @include('suppliers.layout.notifications')
    <!-- /Notifications -->
...
@include('suppliers.layout.scripts')
